...
ActiveRecord::Schema.define(version: 2020_10_30_232711) do
  ...
  create_table "deposits", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.bigint "user_id"
    t.integer "amount"
    t.boolean "is_active"
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "refunds", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.bigint "user_id"
    t.integer "amount"
    t.boolean "is_active"
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "shipping_fees", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.bigint "shipping_id"
    t.string "area_1"
    t.string "area_2"
    t.string "area_3"
  ...
  create_table "shippings", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
