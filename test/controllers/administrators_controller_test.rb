...
class AdministratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post administrators_url, params: { administrator: { email: @administrator.email, force: @administrator.force, password: 'secret', password_confirmation: 'secret' } }
    end
  ...
  test "should update administrator" do
    patch administrator_url(@administrator), params: { administrator: { email: @administrator.email, force: @administrator.force, password: 'secret', password_confirmation: 'secret' } }
